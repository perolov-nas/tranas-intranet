/**
 * Tranås Intranät - Systeminställningar
 *
...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        initSystemPreferencesForm();
    });

    /**
     * Initiera system-inställningsformulär
     */
    function initSystemPreferencesForm() {
        const form = document.getElementById('tranas-system-preferences-form');
    ...
    function handleSubmit(e) {
        ...
        formData.append('action', 'tranas_save_system_preferences');

        // Hämta nonce från formulärets dolda fält
        const nonceField = form.querySelector('[name="tranas_system_nonce"]');
        if (nonceField) {
        ...
        .catch(function(error) {
            console.error('Fel vid sparning av systeminställningar:', error);
